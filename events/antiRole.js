...
async function handleRoleCreate(role) {
  try {
    ...
    await role.guild.members.ban(executorMember.id, { reason: 'Anti Role Create | Not Whitelisted' });
...
async function handleRoleDelete(role) {
  try {
    ...
    await role.guild.members.ban(executorMember.id, { reason: 'Anti Role Delete | Not Whitelisted' });
...
async function handleRoleUpdate(oldRole, newRole) {
  try {
    ...
    await newRole.guild.members.ban(executorMember.id, { reason: 'Anti Role Update | Not Whitelisted' });
